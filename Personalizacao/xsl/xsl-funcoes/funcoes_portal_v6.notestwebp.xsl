<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl-extensoes="urn:xsl-extensoes" exclude-result-prefixes="xsl-extensoes">
  ...
  <xsl:template name="cria-link-diretorio">
    ...
    <a itemprop="isBasedOn" href="{$diretorio}/{@url}" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
  ...
  <xsl:template name="cria-link-diretorio-agencia">
    ...
    <h2>
      <a itemprop="isBasedOn" href="{$diretorio}/{@url}" title="{@manchete}" data-track-category="Notícias - Agência" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
        <xsl:value-of select="@manchete"/>
      </a>
    </h2>
    <p>
      <a itemprop="isBasedOn" href="{$diretorio}/{@url}" title="{@destaque}" data-track-category="Notícias - Agência" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
  ...
  <xsl:template name="cria-link-diretorio-mobile">
    ...
    <a itemprop="isBasedOn" href="{$diretorio}/{@url}" title="{@manchete}" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
      <xsl:value-of select="@manchete"/>
    </a>
  </xsl:template>
  ...
  <xsl:template name="linkfoto_assunto_destaque_manchete_v5">
    ...
    <xsl:variable name="_conteudo">
      <div>
        <a itemprop="isBasedOn" href="{$link}" title="$manchete" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {$manchete}">
          <img class="lazyload" data-src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{$manchete}" />
        </a>
  ...
  <xsl:template name="linkfotodestaque">
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$diretorio}/{@url}" title="" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <figure>
          <xsl:copy-of select="$_conteudo"/>
        </figure>
      </a>
    ...
    <xsl:if test="$link!=''">
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$link}" title="" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <figure>
          <xsl:copy-of select="$_conteudo" />
        </figure>
      </a>
  ...
  <xsl:template name="linkfotomanchete">
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption=''">
          <img data-src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img data-src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$diretorio}/{@url}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}" target="{$target}">
        <figure>
          <xsl:copy-of select="$_conteudo"/>
        </figure>
      </a>
    ...
    <xsl:if test="$link!=''">
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$link}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}" target="{$target}">
        <xsl:copy-of select="$_conteudo" />
      </a>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="linkfoto">
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $_widthbox!='100' ">
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:when test="$caption='' and $_widthbox='100'">
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}%" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    ...
    <xsl:if test="$link=''">
      <a itemprop="isBasedOn" href="{$diretorio}/{@url}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo"/>
      </a>
    </xsl:if>

    <xsl:if test="$link!=''">
      <a itemprop="isBasedOn" href="{$link}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo" />
      </a>
    </xsl:if>
  </xsl:template>
    ...
    <xsl:choose>
      <xsl:when test="fotodestaque/@arquivo!=''">
        ...
        <div class="media-left">
          <a itemprop="isBasedOn" href="{$diretorio_url}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem - Notícia - {@manchete}">
  ...
  <xsl:template name="carregaImagensAgencia">
    ...
    <xsl:choose>
      <xsl:when test="fotodestaque/@arquivo!=''">
        ...
        <div class="col-md-1">
          <a itemprop="isBasedOn" href="{$diretorio_url}" title="{@manchete}">
      ...
      <xsl:otherwise>
        <div class="col-md-1">
          <a itemprop="isBasedOn" href="{$diretorio_url}" class="media-object agencia-img" title="{@manchete}">
  ...
  <xsl:template name="linkfoto_v6">
    ...
    <xsl:variable name="_conteudo">
      <img class="lazyload" data-src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" style="width:{$widthboxPERC}%" alt="{$_legenda}" />
    </xsl:variable>
  ...
  <xsl:template name="linkfotodestaquecbn">
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$diretorio}/{@url}" title="{@manchete}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo"/>
      </a>
    </xsl:if>

    <xsl:if test="$link!=''">
      <a itemprop="isBasedOn" class="img-thumb-zoom" href="{$link}" title="{@manchete}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo" />
      </a>
    </xsl:if>
  </xsl:template>
