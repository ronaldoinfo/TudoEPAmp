<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl-extensoes="urn:xsl-extensoes" exclude-result-prefixes="xsl-extensoes">
  ...
  <xsl:template name="cria-link-diretorio">
    ...
    <a itemprop="url" href="{$diretorio}/{@url}" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
  ...
  <xsl:template name="cria-link-diretorio-agencia">
    ...
    <h2>
      <a itemprop="relatedLink" href="{$diretorio}/{@url}" title="{@manchete}" data-track-category="Notícias - Agência" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
        <xsl:value-of select="@manchete"/>
      </a>
    </h2>
    <p>
      <a itemprop="relatedLink" href="{$diretorio}/{@url}" title="{@destaque}" data-track-category="Notícias - Agência" data-track-event="click" data-track-label="Link: Notícia: {@manchete}">
    ...
    <xsl:variable name="_conteudo">
      <div>
        <a itemprop="url" href="{$link}">
          <img class="lazyload" data-src="{$nomeimagemtipo}"></img>
        </a>
  ...
  <xsl:template name="fazlink">
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="url" href="{$diretorio}/{$url-amigavel}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Notícia - {$conteudo}">
        <span class="no-margin-top" itemprop="name">
    ...
    <xsl:if test="$link!=''">
      <a itemprop="url" href="{$link}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Notícia - {$conteudo}">
        <span itemprop="name">
          <xsl:copy-of select="$conteudo" />
        </span>
      </a>
  ...
  <xsl:template name="linksecao">
    ...
    <a itemprop="relatedLink" href="{$linksecao}">
  ...
  <xsl:template name="linkfotodestaque">
    ...
    <xsl:variable name="larguraimagem">
      <xsl:if test="$tamanho=''">
        <xsl:value-of select="240"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$tamanho='pq'">
        <xsl:value-of select="90"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$tamanho!='' and $tamanho!='pq'">
    ...
    <xsl:variable name="alturaimagem">
      <xsl:if test="$altura=''">
        <xsl:value-of select="180"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$altura='pq'">
        <xsl:value-of select="68"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$altura!='' and $altura!='pq'">
        <xsl:value-of select="$altura"></xsl:value-of>
      </xsl:if>
    </xsl:variable>

    <xsl:variable name="_conteudo">
      <img data-src="{$nomeimagemtipo}" class="{concat('destaque',$tamanho,' lazyload')} {$cssclass}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{@manchete}" />
    </xsl:variable>
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="relatedLink" class="img-thumb-zoom" href="{$diretorio}/{@url}" title="" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <figure>
          <xsl:copy-of select="$_conteudo"/>
        </figure>
      </a>
    ...
    <xsl:if test="$link!=''">
      <a itemprop="relatedLink" class="img-thumb-zoom" href="{$link}" title="" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Destaque - Notícia: {@manchete}">
        <figure>
          <xsl:copy-of select="$_conteudo" />
        </figure>
      </a>
  ...
  <xsl:template name="linkfotomanchete">
    ...
    <xsl:variable name="larguraimagem">
      <xsl:if test="$tamanho=''">
        <xsl:value-of select="364"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$tamanho!=''">
        <xsl:value-of select="$tamanho"></xsl:value-of>
      </xsl:if>
    ...
    <xsl:variable name="alturaimagem">
      <xsl:if test="$larguraimagem='364'">
        <xsl:value-of select="205"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$larguraimagem='100'">
        <xsl:value-of select="70"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$larguraimagem='90'">
        <xsl:value-of select="68"></xsl:value-of>
      </xsl:if>
    </xsl:variable>
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $tamanho!='100' ">
          <img data-src="{$nomeimagemtipo}" class="{concat('manchete',$tamanho,' lazyload')} {$cssclass}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:when test="$caption='' and $tamanho='100'">
          <img data-src="{$nomeimagemtipo}" class="lazyload" width="{$larguraimagem}%" height="{$alturaimagem}%" alt="" title="" />
        </xsl:when>
        <xsl:otherwise>
          <img data-src="{$nomeimagemtipo}" class="{concat('manchete',$tamanho,' lazyload')} {$cssclass}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="relatedLink" class="img-thumb-zoom" href="{$diretorio}/{@url}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}" target="{$target}">
        <figure>
          <xsl:copy-of select="$_conteudo"/>
        </figure>
      </a>
    ...
    <xsl:if test="$link!=''">
      <a itemprop="relatedLink" class="img-thumb-zoom" href="{$link}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}" target="{$target}">
        <xsl:copy-of select="$_conteudo" />
      </a>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="linkfoto">
    ...
    <xsl:variable name="_widthbox">
      <xsl:if test="$widthbox!=''">
        <xsl:value-of select="$widthbox"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$widthbox=''">
        <xsl:value-of select="100"></xsl:value-of>
      </xsl:if>
    </xsl:variable>
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $_widthbox!='100' ">
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:when test="$caption='' and $_widthbox='100'">
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}%" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img data-src="{$nomeimagemtipo}" width="{$_widthbox}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    ...
    <xsl:if test="$link=''">
      ...
      <a itemprop="url" href="{$diretorio}/{@url}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo"/>
      </a>
    </xsl:if>

    <xsl:if test="$link!=''">
      <a itemprop="url" href="{$link}" title="{$_legenda}{$_credito}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem Manchete - Notícia: {@manchete}">
        <xsl:copy-of select="$_conteudo" />
      </a>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="carregaImagensBoxes">
    ...
    <xsl:choose>
      <xsl:when test="fotodestaque/@arquivo!=''">
        ...
        <a itemprop="relatedLink" href="{$diretorio_url}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem - Notícia - {@manchete}">
          <img src="{$imagens_ep}/{$nomeimagematamanho}" alt="{@manchete}" width="90" height="68" align="left" />
        </a>
      </xsl:when>
      <xsl:otherwise>
    ...
    <xsl:choose>
      <xsl:when test="fotodestaque/@arquivo!=''">
        ...
        <div class="media-left">
          <a itemprop="relatedLink" href="{$diretorio_url}" data-track-category="Box - Notícias" data-track-event="click" data-track-label="Link: Imagem - Notícia - {@manchete}">
            <img class="media-object" src="{$imagens_ep}/{$nomeimagematamanho}" alt="{@manchete}" width="90" height="68" />
          </a>
        </div>
      </xsl:when>
      <xsl:otherwise>
  ...
  <xsl:template name="carregaImagensAgencia">
    ...
    <xsl:choose>
      <xsl:when test="fotodestaque/@arquivo!=''">
        ...
        <div class="col-md-1">
          <a itemprop="relatedLink" href="{$diretorio_url}" title="{@manchete}">
      ...
      <xsl:otherwise>
        ...
        <div class="col-md-1">
          <a itemprop="relatedLink" href="{$diretorio_url}" class="media-object agencia-img" title="{@manchete}">
  ...
  <xsl:template name="linkfoto_v6">
    ...
    <xsl:variable name="_conteudo">
       <img src="{$nomeimagemtipo}" width="{$widthbox}" height="{$height}" style="width:{$widthboxPERC}%"  />
    </xsl:variable>
  ...
  <xsl:template name="linkfotodestaquecbn">
    ...
    <xsl:variable name="larguraimagem">
      ...
      <xsl:if test="$tamanho='colunistas'">
        <xsl:value-of select="80"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$tamanho!='' and $tamanho!='pq' and $tamanho!='colunistas'">
        <xsl:value-of select="$tamanho"></xsl:value-of>
      </xsl:if>
    </xsl:variable>
    ...
    <xsl:variable name="alturaimagem">
      ...
      <xsl:if test="$altura='colunistas'">
        <xsl:value-of select="80"></xsl:value-of>
      </xsl:if>
      <xsl:if test="$altura!='' and $altura!='pq' and $altura!='colunistas'">
        <xsl:value-of select="$altura"></xsl:value-of>
      </xsl:if>
    </xsl:variable>

    <xsl:variable name="_conteudo">
      <img src="{$nomeimagemtipo}" class="{concat('destaque',$tamanho)} {$cssclass}" width="{$larguraimagem}" height="{$alturaimagem}" alt="" title="" />
    </xsl:variable>
