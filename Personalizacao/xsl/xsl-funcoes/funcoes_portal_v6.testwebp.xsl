    ...
    <xsl:variable name="_conteudo">
      <div>
        <a itemprop="isBasedOn" href="{$link}" title="$manchete" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {$manchete}">
          <picture>
              <source type="image/webp" srcset="{$nomeimagemtipo}" />
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $_widthbox!='100' ">
          <picture>
            <source type="image/webp" srcset="{$nomeimagemtipo}" />
            <img data-src="{$nomeimagemtipojpg}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
          </picture>          
        </xsl:when>
        <xsl:when test="$caption='' and $_widthbox='100'">
          <picture>
        ...
        <xsl:otherwise>
          <picture>
            <source type="image/webp" srcset="{$nomeimagemtipo}" />
            <img data-src="{$nomeimagemtipojpg}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
          </picture>          
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
