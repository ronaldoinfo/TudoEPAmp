<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl-extensoes="urn:xsl-extensoes" exclude-result-prefixes="xsl-extensoes">
    ...
    <xsl:variable name="_conteudo">
      <div>
        <a itemprop="isBasedOn" href="{$link}" title="$manchete" data-track-category="Notícias" data-track-event="click" data-track-label="Link: Notícia: {$manchete}">
          <img class="lazyload" src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{$manchete}" />
        </a>
  ...
  <xsl:template name="linkfotodestaque">
    ...
    <xsl:variable name="_conteudo">
      <img src="{$nomeimagemtipo}" class="{concat('destaque',$tamanho,' lazyload')} {$cssclass}" width="{$larguraimagem}" height="{$alturaimagem}" alt="{@manchete}" />
    </xsl:variable>
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption=''">
          <img src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img src="{$nomeimagemtipo}" width="{$larguraimagem}" height="{$alturaimagem}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $_widthbox!='100' ">
          <img src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:when test="$caption='' and $_widthbox='100'">
          <img src="{$nomeimagemtipo}" width="{$_widthbox}%" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template name="get-foto">
    ...
    <xsl:variable name="_conteudo">
      <xsl:choose>
        <xsl:when test="$caption='' and $_widthbox!='100' ">
          <img src="{$nomeimagemtipo}" width="{$_widthbox}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:when test="$caption='' and $_widthbox='100'">
          <img src="{$nomeimagemtipo}" width="{$_widthbox}%" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$_legenda}{$_credito}" />
        </xsl:when>
        <xsl:otherwise>
          <img src="{$nomeimagemtipo}" width="{$_widthbox}" class="lazyload {$cssclass}" alt="{$_legenda}{$_credito}" title="{$caption}" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    <xsl:copy-of select="$_conteudo"/>
  ...
  <xsl:template name="linkfoto_v6">
    ...
    <xsl:variable name="_conteudo">
      <img class="lazyload" src="{$nomeimagemtipo}" width="{$_widthbox}" height="{$_height}" style="width:{$widthboxPERC}%" alt="{$_legenda}" />
    </xsl:variable>
